...
import com.example.icookadapizza.*;
import com.example.icookadapizza.Controllers.MainMenuController;
...
public class SpecialtiesController {
    ...
    private void setPizzaImageViewHelper(String selectedPizzaName){
        if(selectedPizzaName.equals("Deluxe")){
            try {
                InputStream stream = new FileInputStream("iCookaDaPizza/src/main/resources/com/example/icookadapizza/Images/deluxePizzaImage.jpg");
            ...
            try {
                InputStream stream = new FileInputStream("iCookaDaPizza/src/main/resources/com/example/icookadapizza/Images/supremePizzaImage.jpg");
                Image image = new Image(stream);
                specialtyPizzaimageView.setImage(image);
            }catch(FileNotFoundException e){
                e.printStackTrace();
    ...
    private void setPizzaimageViewHelperTwo(String selectedPizzaName){
        if(selectedPizzaName.equals("Meatzza")){
            try {
                InputStream stream = new FileInputStream("iCookaDaPizza/src/main/resources/com/example/icookadapizza/Images/meatzzaPizzaImage.jpg");
                Image image = new Image(stream);
                specialtyPizzaimageView.setImage(image);
            }catch(FileNotFoundException e){
                e.printStackTrace();
            ...
            try {
                InputStream stream = new FileInputStream("iCookaDaPizza/src/main/resources/com/example/icookadapizza/Images/seafoodPizzaImage.jpg");
                Image image = new Image(stream);
                specialtyPizzaimageView.setImage(image);
            }catch(FileNotFoundException e){
                e.printStackTrace();
            ...
            try {
                InputStream stream = new FileInputStream("iCookaDaPizza/src/main/resources/com/example/icookadapizza/Images/pepperoniPizzaImage.jpg");
                Image image = new Image(stream);
                specialtyPizzaimageView.setImage(image);
            }catch(FileNotFoundException e){
                e.printStackTrace();
